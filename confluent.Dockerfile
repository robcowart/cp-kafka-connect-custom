...
FROM robcowart/cp-kafka-connect-custom:5.3.1_0.0.4_community
...
LABEL org.opencontainers.image.created="$BUILD_DATE" \
      ...
      org.opencontainers.image.version="5.3.1_0.0.4_confluent" \
...
RUN confluent-hub install --no-prompt confluentinc/kafka-connect-activemq:5.3.1 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-activemq-sink:1.1.2 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-aws-cloudwatch-metrics:1.0.0-preview && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-aws-cloudwatch-logs:1.0.2 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-aws-dynamodb:1.0.2 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-aws-lambda:1.0.1 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-aws-redshift:1.0.1 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-azure-blob-storage-source:1.1.1-preview && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-azure-blob-storage:1.1.2 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-azure-data-lake-gen1-storage:1.1.2 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-azure-data-lake-gen2-storage:1.2.2 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-azure-event-hubs:1.0.1 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-azure-functions:1.0.4 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-azure-service-bus:1.0.0-preview && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-azure-sql-dw:1.0.2 && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-firebase:1.0.0-preview && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-gcp-bigtable:1.0.1 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-gcp-dataproc-sink:1.0.1-preview && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-gcp-functions:1.0.5 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-gcp-pubsub:1.0.1-preview && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-gcs-source:1.1.1 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-hbase:1.0.1-preview && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-hdfs3:1.0.4 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-hdfs3-source:1.1.1-preview && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-influxdb:1.1.1-preview && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-kudu:1.0.0-preview && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-salesforce:1.3.3 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-servicenow:1.0.2-preview && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-sftp:1.0.0-preview && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-solace-sink:1.1.2-preview && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-solace-source:1.0.1-preview && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-teradata:1.0.0-preview && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-tibco-sink:1.1.2 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-tibco-source:1.0.1 && \
