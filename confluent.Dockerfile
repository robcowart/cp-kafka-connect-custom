...
FROM robcowart/cp-kafka-connect-custom:5.4.0_1.0.0_community
...
LABEL org.opencontainers.image.created="$BUILD_DATE" \
      ...
      org.opencontainers.image.version="5.4.0_1.0.0_confluent" \
...
RUN confluent-hub install --no-prompt confluentinc/kafka-connect-activemq:5.4.0 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-activemq-sink:1.1.2 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-aws-cloudwatch-metrics:1.0.2 && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-azure-blob-storage-source:1.2.1 && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-azure-service-bus:1.0.1 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-azure-sql-dw:1.0.2 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-cassandra:1.1.4 && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-gcp-bigtable:1.0.3 && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-gcs:5.4.0 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-gcs-source:1.2.1 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-hbase:1.0.3 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-hdfs3:1.0.4 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-hdfs2-source:1.2.1-preview && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-hdfs3-source:1.2.1 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-http:1.0.4 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-ibmmq:5.4.0 && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-jms:5.4.0 && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-replicator:5.4.0 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-s3-source:1.2.1 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-salesforce:1.4.1 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-salesforce-bulk-api:1.4.1-preview && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-servicenow:1.1.2 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-sftp:1.0.2 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-snmp:1.0.0-preview && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-teradata:1.0.1 && \
