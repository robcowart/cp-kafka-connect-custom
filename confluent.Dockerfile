...
FROM robcowart/cp-kafka-connect-custom:5.4.1_1.0.1_community
...
LABEL org.opencontainers.image.created="$BUILD_DATE" \
      ...
      org.opencontainers.image.version="5.4.1_1.0.1_confluent" \
...
RUN confluent-hub install --no-prompt confluentinc/kafka-connect-activemq:5.4.1 && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-azure-blob-storage:1.3.1 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-azure-data-lake-gen1-storage:1.3.1 && \
    confluent-hub install --no-prompt confluentinc/kafka-connect-azure-data-lake-gen2-storage:1.3.1 && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-azure-service-bus:1.0.2 && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-ibmmq:5.4.1 && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-jms:5.4.1 && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-salesforce-bulk-api:1.4.2-preview && \
    ...
    confluent-hub install --no-prompt confluentinc/kafka-connect-teradata:1.0.2 && \
